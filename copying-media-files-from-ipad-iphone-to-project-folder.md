...
8. Open a Finder window and navigate to your project folder.9. In Image Capture, select the media files you'd like copy to your project folder. Press and hold the Command key (on your keyboard) to select multiple media files.10. Click and drag the selected media files in Image Capture into your project folder.
